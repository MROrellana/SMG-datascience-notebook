...
#determina fecah un mes atras
menor = str(datetime.datetime.today() - datetime.timedelta(days=30))[:10]
#solose utiliza la gerencia 18, 19 
gerencia = "18, 19"
...
mes = calendar.month_name[datetime.datetime.today().month]
#path = "quejas_metrica\Métrica Quejas {mes}.xlsx"


import os

directory = "quejas_metrica"
file = "quejas_metricas.xlsx"


final.to_excel(os.path.join(directory,file))

print(os.path.dirname(join(directory,file)))
