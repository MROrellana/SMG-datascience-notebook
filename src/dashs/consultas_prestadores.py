...
App_1 = dash.Dash(__name__, server=server, url_base_pathname='/consultas_prestadores/', external_stylesheets=external_stylesheets )
                    ...
                    style_data_conditional=[     
                        {
                         ...
                         'filter_query': "{Promedio edad de afiliados} >= 50 and {2 consultas - participación %} >= 30"
                             },
                         ...
                         {
                          'if': {'column_id': '2 consultas - participación %',
                         'filter_query': "({Promedio edad de afiliados} >= 50 and {2 consultas - participación %} < 30 and {2 consultas - participación %} > 20)"
                             },
                         ...
                         {
                          'if': {'column_id': '2 consultas - participación %',
                         'filter_query': "{Promedio edad de afiliados} >= 50 and {2 consultas - participación %} <= 20"
                             },
...

                        {
                         ...
                         'filter_query': "{Promedio edad de afiliados} >= 50 and {3 consultas - participación %} >= 20"
                             },
                         'backgroundColor': '#cb3234',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': '3 consultas - participación %',
                         'filter_query': "({Promedio edad de afiliados} >= 50 and {3 consultas - participación %} < 20 and {3 consultas - participación %} > 15)"
                             },
                         'backgroundColor': '#f8f32b',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': '3 consultas - participación %',
                         'filter_query': "{Promedio edad de afiliados} >= 50 and {3 consultas - participación %} <= 15"
                             },
                         'backgroundColor': '#008f39',
                         'color': 'white',
                        },

                        {
                         ...
                         'filter_query': "{Promedio edad de afiliados} >= 50 and {4 consultas - participación %} >= 15"
                             },
                         'backgroundColor': '#cb3234',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': '4 consultas - participación %',
                         'filter_query': "({Promedio edad de afiliados} >= 50 and {4 consultas - participación %} < 15 and {4 consultas - participación %} > 11)"
                             },
                         'backgroundColor': '#f8f32b',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': '4 consultas - participación %',
                         'filter_query': "{Promedio edad de afiliados} >= 50 and {4 consultas - participación %} <= 11"
                             },
                         'backgroundColor': '#008f39',
                         'color': 'white',
                        },

                        {
                         ...
                         'filter_query': "{Promedio edad de afiliados} >= 50 and {Más de 4 - participación %} >= 10"
                             },
                         'backgroundColor': '#cb3234',
                         'color': 'white',
                        },
                      ...
                      #   {
                      #    'if': {'column_id': 'Más de 4 - participación %',
                      #   'filter_query': "{Promedio edad de afiliados} >= 50 and {Más de 4 - participación %} < 30 and {Más de 4 - participación %} > 20  "
                      #       },
                      #   'backgroundColor': '#f8f32b',
                      #   'color': 'white',
                      #  },
...

                        {
                         ...
                         'filter_query': "{Promedio edad de afiliados} >= 50 and {Participación %} >= 35"
                             },
                         'backgroundColor': '#cb3234',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': 'Participación %',
                         'filter_query': "({Promedio edad de afiliados} >= 50 and {Participación %} < 35 and {Participación %} > 25)"
                             },
                         'backgroundColor': '#f8f32b',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': 'Participación %',
                         'filter_query': "{Promedio edad de afiliados} >= 50 and {Participación %} <= 25"
                             },
                         'backgroundColor': '#008f39',
                         'color': 'white',
                        },
...
#menores de 50
                         ...
                         {
                          'if': {'column_id': '2 consultas - participación %',
                         'filter_query': "({Promedio edad de afiliados} < 50 and {2 consultas - participación %} < 20 and {2 consultas - participación %} > 10)"
                             },
                         'backgroundColor': '#f8f32b',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': '2 consultas - participación %',
                         'filter_query': "{Promedio edad de afiliados} < 50 and {2 consultas - participación %} <= 10"
                             },
                         'backgroundColor': '#008f39',
                         'color': 'white',
                        },
                        ...
                        {
                          'if': {'column_id': '3 consultas - participación %',
                         'filter_query': "{Promedio edad de afiliados} < 50 and {3 consultas - participación %} >= 10"
                             },
                         'backgroundColor': '#cb3234',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': '3 consultas - participación %',
                         'filter_query': "({Promedio edad de afiliados} < 50 and {3 consultas - participación %} < 10 and {3 consultas - participación %} > 5)"
                             },
                         'backgroundColor': '#f8f32b',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': '3 consultas - participación %',
                         'filter_query': "{Promedio edad de afiliados} < 50 and {3 consultas - participación %} <= 5"
                             },
                         'backgroundColor': '#008f39',
                         'color': 'white',
                        },
                        ...
                        {
                          'if': {'column_id': '4 consultas - participación %',
                         'filter_query': "{Promedio edad de afiliados} < 50 and {4 consultas - participación %} >= 5"
                             },
                         'backgroundColor': '#cb3234',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': '4 consultas - participación %',
                         'filter_query': "({Promedio edad de afiliados} < 50 and {4 consultas - participación %} < 5 and {4 consultas - participación %} > 1)"
                             },
                         'backgroundColor': '#f8f32b',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': '4 consultas - participación %',
                         'filter_query': "{Promedio edad de afiliados} < 50 and {4 consultas - participación %} <= 1"
                             },
                         'backgroundColor': '#008f39',
                         'color': 'white',
                        },
                        ...
                        {
                          'if': {'column_id': 'Más de 4 - participación %',
                         'filter_query': "{Promedio edad de afiliados} < 50 and {Más de 4 - participación %} >= 0"
                             },
                         'backgroundColor': '#cb3234',
                         'color': 'white',
                        },
                      ...
                      #  },
...

                        {
                         ...
                         {
                          'if': {'column_id': 'Participación %',
                         'filter_query': "({Promedio edad de afiliados} < 50 and {Participación %} < 25 and {Participación %} > 15)"
                             },
                         'backgroundColor': '#f8f32b',
                         'color': 'white',
                        },
                         ...
                         {
                          'if': {'column_id': 'Participación %',
                         'filter_query': "{Promedio edad de afiliados} < 50 and {Participación %} <= 15"
                             },
                         'backgroundColor': '#008f39',
                         'color': 'white',
                        }
...
def filtros_ordenes(start_date, end_date):
    ...
    #   and a11.id_pre_prestador not in ({modelos})
    ...
    reconsultas = df.groupby(["id_pre_prestador", "desc_pre_nombre", "desc_prof_especialidad", "id_afi_afiliado"])["id_afi_afiliado"].count().rename("CANTIDADORDENES0").reset_index()
    reconsultas["uno"] = 1
    ...
    total_consultas_prestador = reconsultas.groupby(["id_pre_prestador",  "desc_pre_nombre", "desc_prof_especialidad"])["CANTIDADORDENES0"].sum()
